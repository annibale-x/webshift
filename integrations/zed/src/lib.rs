...
const GITHUB_REPO: &str = "x-hannibal/webshift";
        ...
        Ok(Some(ContextServerConfiguration {
            installation_instructions:
                "mcp-webshift is installed automatically from \
                 [GitHub Releases](https://github.com/x-hannibal/webshift/releases).\n\
                 No manual setup required — the native binary is downloaded on first use.\n\n\
                 Keys are [CLI arguments](https://github.com/x-hannibal/webshift/blob/main/docs/CONFIGURATION.md#cli-arguments-mcp-server-only)."
                    .to_string(),
