...
For client-specific setup (Claude Desktop, Claude Code, Zed, Cursor, Windsurf, VS Code, Gemini CLI) see [docs/integrations/](https://github.com/x-hannibal/webshift/tree/main/docs/integrations).
...
For the full configuration reference (all TOML keys, env vars, CLI args) see [docs/CONFIGURATION.md](https://github.com/x-hannibal/webshift/blob/main/docs/CONFIGURATION.md).
...
- **[Configuration Reference](https://github.com/x-hannibal/webshift/blob/main/docs/CONFIGURATION.md)**
- **[Use Cases & Examples](https://github.com/x-hannibal/webshift/blob/main/docs/USE_CASES.md)**
- **[IDE & Agent Integration Guides](https://github.com/x-hannibal/webshift/tree/main/docs/integrations)**
